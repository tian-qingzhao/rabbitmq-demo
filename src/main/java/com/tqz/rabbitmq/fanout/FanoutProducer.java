...
public class FanoutProducer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        channel.queueDeclare(ConnectionUtil.FANOUT_QUEUE_NAME1, true, false, false, null);
        ...
        channel.queueBind(ConnectionUtil.FANOUT_QUEUE_NAME1, ConnectionUtil.FANOUT_EXCHANGE, "");
        channel.queueBind(ConnectionUtil.FANOUT_QUEUE_NAME3, ConnectionUtil.FANOUT_EXCHANGE, "");
