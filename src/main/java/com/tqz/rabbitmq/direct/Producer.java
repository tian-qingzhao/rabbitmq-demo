...
//        channel.exchangeDelete("test");
        ...
        channel.queueBind(ConnectionUtil.QUEUE_NAME1, ConnectionUtil.DIRECT_EXCHANGE,"info.user");
        channel.queueBind(ConnectionUtil.QUEUE_NAME2, ConnectionUtil.DIRECT_EXCHANGE,"error.user");
        channel.queueBind(ConnectionUtil.QUEUE_NAME3, ConnectionUtil.DIRECT_EXCHANGE,"debug.user");
        channel.queueBind(ConnectionUtil.QUEUE_NAME4, ConnectionUtil.DIRECT_EXCHANGE,"info.user");
        ...
        while (true){
            channel.basicPublish(ConnectionUtil.DIRECT_EXCHANGE,"info.user",null,message.getBytes());
            //关闭资源
//            channel.close();
//            connection.close();
            Thread.sleep(800);
