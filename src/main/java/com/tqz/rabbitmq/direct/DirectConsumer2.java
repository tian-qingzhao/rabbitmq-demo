...
//        channel.basicQos(12);
        channel.queueDeclare(ConnectionUtil.DIRECT_QUEUE_NAME2, true, false, false, null);
        //接受消息，开始消费
        channel.basicConsume(ConnectionUtil.DIRECT_QUEUE_NAME2, new MyDefaultConsumer(channel));
