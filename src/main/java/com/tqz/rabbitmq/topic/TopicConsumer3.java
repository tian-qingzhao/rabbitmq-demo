...
//        channel.basicQos(12);
        channel.queueDeclare(ConnectionUtil.TOPIC_QUEUE_NAME3, true, false, false, null);
        //接受消息，开始消费
        channel.basicConsume(ConnectionUtil.TOPIC_QUEUE_NAME3, new MyDefaultConsumer(channel));
