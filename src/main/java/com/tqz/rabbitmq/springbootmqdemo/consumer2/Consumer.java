package com.tqz.rabbitmq.springbootmqdemo.consumer2;
...
public class Consumer {
     ...
     * @param message
     */
    @RabbitListener(queues = "0427 13:17 Queue",containerFactory = "simpleRabbitListenerContainerFactory")
...
//            channel.basicReject(message.getMessageProperties().getDeliveryTag(),true);
      ...
      /*  JSONObject jsonObject = JSON.parseObject(msg);
        ...
        System.out.println("消费者2拿到的消息：" + new String(message.getBody(),"UTF-8"));
    }
